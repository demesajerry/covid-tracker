...
<!-- Content Header (Page header) -->
    ...
    <?php } ?>
        ...
        <li class="active">Transferred to Station</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            ...
            <div >
        <form method="POST" action="<?php echo base_url().'reports/transfer_history'; ?>">
                <div class="box">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                ...
                                <br><hr>
                                <div class="col-lg-4"> Disposed by Station: </div>
                                <div class="col-lg-8">
                        ...
                        <div class="col-lg-3">
                            <div class="col-lg-4">Disposed By: </div>
                                <div class="col-lg-8">
                                    <select name="disposed_by" id="disposed_by" class="select2 form-control">
                        ...
                        <div class="col-lg-3">
                            <div class="col-lg-4"> Disposed to: </div>
                              <div class="col-lg-8"> 
                                  <select name="to_station_id" id="to_station_id" class="select2 form-control" style="width:100%;">
                                    <option selected disabled>Select Health Station</option>
                                    <?php foreach($station_list as $station){ ?>
                                        <option value="<?= $station->station_id; ?>"><?= $station->brgy; ?></option>
                                    <?php } ?>
                    ...
                    <table class="table table-bordered table-hover" id="history_table">
                        ...
                        <tr class="bg-info">
                           <th width="5%">TransID</th>
                            <!-- <th>StockID</th>-->
                            <th width="20%">Medicine</th>
                            <th width="15%">Preparation</th>
                            <th width="5%">quantity</th>
                            <th width="10%">Date Disposed</th>
                            <th width="10%">Disposed By</th>
                            <th width="10%">Disposed To</th>
                            <th width="10%">Disposed By Station </th>
                        ...
                        foreach($history as $his){ 
                            ...
                            <tr class="<?php echo $current_color; ?>">
                                <td style="border-top: none;"><p style="display: none;"><?php echo $his->transaction_id; ?></p></td>
                                ...
                                <td><p style="display: none;"><?php echo $his->dfname." ".$his->dlname; ?></p></td>
                                <td><p style="display: none;"><?php echo $his->transfered_station; ?></p></td>
                                <td><p style="display: none;"><?php echo $his->station; ?></p></td>
                                <td><p style="display: none;"><?php echo $his->remarks; ?></p></td>
                                <td>
                            ...
                            <tr class="<?php echo $current_color; ?>">
                                ...
                                <td><?php echo $his->transfered_station; ?></td>
                                ...
                                <td>
                                    ...
                                    |
                                    <a href="#"  class="view_photo" trans_id="<?php echo $his->transaction_id; ?>" sold_to="<?php echo $his->sold_to; ?>" >
                                    <i class="fa fa-camera" > </i>
                                    </a>
                                </td>
...
$(".view_photo").click(function() {
    var trans_id = this.getAttribute("trans_id");
    var sold_to = this.getAttribute("sold_to");
    $('#display_photo').html('<img src="<?php echo base_url(); ?>assets/images/upload/station'+sold_to+'trans'+trans_id+'.jpg" class="user-image" width="570px" height="320">');
    ...
    "buttons":[
                {
                  extend: 'excel',
                  text: 'Excel',
                  title:"Medicine Tranfered History<?php 
