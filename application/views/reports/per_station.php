...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
      <div class="box">
      <form method="POST" action="<?php echo base_url().'reports/per_station'; ?>">
              <div class="box-body table-responsive">
                <div class="col-lg-3">
                  <div class="col-lg-4">Disposed From:</div>
                  <div class="col-lg-8"><input type="text" class="form-control" name="disposed_from" id="disposed_from"></div>
                </div>
                <div class="col-lg-3">
                  <div class="col-lg-4">Disposed To:</div>
                  <div class="col-lg-8"><input type="text" class="form-control" name="disposed_to" id="disposed_to"></div>
                </div>
                <div class="col-lg-5">
                  <div class="col-lg-2">Barangay:</div>
                  <div class="col-lg-10">
                ...
                <div class="box">
                    ...
                    <h3 class="box-title">Disposal per Health Station</h3>
                        <div class="box-tools">
                        </div>
                    </div>
                <div class="box-body table-responsive">
    ...
    "buttons":[
                {
                  extend: 'excel',
                  text: 'Excel',
                  title:"RHU Medicine Disposal per Health Station",
                  messageTop:"<?php 
